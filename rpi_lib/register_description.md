...
| 10 | porf | Indicates that the ATTiny reset was caused by power on.
| 11 | extrf | Indicates that the ATTiny reset was caused externally (e.g. firmware update)
| 12 | borf | Indicates that the ATTiny reset was caused by a brownout
| 13 | wdrf | Indicates that the ATTiny reset was caused by the ATTiny's watchdog.
| 14 | wdclr | When this bit is set, the pidog will clear the ATTiny's MCUSR 
| 31-15 | `na` | Reserved |
